...
<head>
    ...
    <title>@yield('header_title', 'Dashboard')</title>
    <!-- Fonts -->
        ...
        <div class="dlabnav">
            <div class="dlabnav-scroll">
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a href="{{ route('classes.index', $prodiParam) }}" class="{{ request()->routeIs('classes.*') && !request()->routeIs('classes.archived') ? 'mm-active' : '' }}">
                            <i class="la la-book"></i>
                            <span class="nav-text">{{ __('Kelas Aktif') }}</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('classes.archived', $prodiParam) }}" class="{{ request()->routeIs('classes.archived') ? 'mm-active' : '' }}">
                            <i class="la la-archive"></i>
                            <span class="nav-text">{{ __('Kelas Arsip') }}</span>
                        </a>
                    </li>
                    ...
                    @if($sidebarUser->can('manage-users') || $sidebarUser->hasRole(['admin', 'kaprodi', 'baak']))
                        ...
                        <li>
                            <a href="{{ route('dosen.index', $prodiParam) }}" class="{{ request()->routeIs('dosen.*') ? 'mm-active' : '' }}">
                                ...
                                <span class="nav-text">{{ __('Data Dosen') }}</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('mahasiswa.index', $prodiParam) }}" class="{{ request()->routeIs('mahasiswa.*') ? 'mm-active' : '' }}">
                                <i class="la la-graduation-cap"></i>
                                <span class="nav-text">{{ __('Data Mahasiswa') }}</span>
                            </a>
                        </li>
                    @endif
                    ...
                    @if($sidebarUser->can('view-institusi') || $sidebarUser->can('manage-obe-curriculum') || $sidebarUser->can('manage-users') || $sidebarUser->can('manage-rbac') || $sidebarUser->hasRole(['admin', 'kaprodi', 'rektor', 'dekan', 'baak', 'finance', 'kemahasiswaan']))
                        ...
                        <li>
                            <a href="{{ route('admin.dashboard') }}">
                                <i class="la la-cog"></i>
                                <span class="nav-text">{{ __('OBE Administration') }}</span>
                            </a>
                        </li>
                    @endif
                </ul>
