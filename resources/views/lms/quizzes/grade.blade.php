...
<div class="container" style="max-width: 800px; margin: 0 auto; padding: 2rem 1rem;">
    ...
    @if(optional($attempt->user->student)->is_frozen)
        <div style="padding: 1.5rem; background: #fee2e2; color: #991b1b; border-radius: 4px; border: 1px solid #f87171; text-align: center; margin-bottom: 2rem;">
            <strong>Belum Eligible</strong><br>
            Mahasiswa ini belum eligible. Penilaian tidak dapat dilakukan sebelum administrasi diselesaikan di Bagian Finance.
        </div>
    @else
