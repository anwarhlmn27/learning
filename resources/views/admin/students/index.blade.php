...
<div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem;">
    <h2 style="margin: 0; font-size: 1.5rem; color: #111827;">Data Mahasiswa</h2>
    ...
    <div class="card-body">
        <form action="{{ route('mahasiswa.index') }}" method="GET" style="display: flex; gap: 1rem; flex-wrap: wrap; align-items: flex-end;">
            <div style="flex: 1; min-width: 200px;">
                ...
                <input type="text" name="search" class="form-control" placeholder="Name, NIM, or Email" value="{{ request('search') }}">
            </div>
            ...
            <div style="display: flex; gap: 0.5rem;">
                ...
                <a href="{{ route('mahasiswa.index') }}" class="btn" style="background: #f3f4f6; text-decoration: none; color: inherit;">Reset</a>
            </div>
        </form>
    </div>
</div>
...
<div class="card">
    <div class="card-body" style="padding: 0;">
        <table style="width: 100%; border-collapse: collapse;">
            <thead>
                <tr>
                    <th style="padding: 1rem; border-bottom: 1px solid #e5e7eb; background: #f9fafb; text-align: left;">NIM</th>
                    <th style="padding: 1rem; border-bottom: 1px solid #e5e7eb; background: #f9fafb; text-align: left;">Nama Mahasiswa</th>
                    <th style="padding: 1rem; border-bottom: 1px solid #e5e7eb; background: #f9fafb; text-align: left;">Angkatan</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="padding: 1rem; border-bottom: 1px solid #e5e7eb;">
                        <button class="btn" style="background: #eef2ff; color: #4f46e5; border: none; padding: 0.25rem 0.5rem; font-size: 0.75rem;" onclick="openEditModal('{{ $student->id }}', '{{ $student->nim }}', '{{ $student->nama_student }}', '{{ $student->angkatan }}', '{{ $student->user->email ?? '' }}', '{{ $student->prodi_id }}')">Edit</button>
                ...
                @empty
                <tr>
                    <td colspan="6" style="padding: 1rem; text-align: center; color: #6b7280;">Tidak ada data mahasiswa.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
...
<div id="modal-add" style="display: none; position: fixed; inset: 0; background: rgba(0,0,0,0.5); z-index: 1000; align-items: center; justify-content: center;">
    <div class="card" style="width: 100%; max-width: 500px; margin: 1rem; max-height: 90vh; overflow-y: auto;">
        <div class="card-header" style="display: flex; justify-content: space-between; align-items: center; position: sticky; top: 0; background: white; z-index: 10;">
            <h3 style="margin: 0; font-size: 1.1rem;">Add Data Mahasiswa</h3>
...
<div id="modal-edit" style="display: none; position: fixed; inset: 0; background: rgba(0,0,0,0.5); z-index: 1000; align-items: center; justify-content: center;">
    <div class="card" style="width: 100%; max-width: 500px; margin: 1rem; max-height: 90vh; overflow-y: auto;">
        <div class="card-header" style="display: flex; justify-content: space-between; align-items: center; position: sticky; top: 0; background: white; z-index: 10;">
            <h3 style="margin: 0; font-size: 1.1rem;">Edit Data Mahasiswa</h3>
...
<div id="modal-import" style="display: none; position: fixed; inset: 0; background: rgba(0,0,0,0.5); z-index: 1000; align-items: center; justify-content: center;">
    <div class="card" style="width: 100%; max-width: 500px; margin: 1rem;">
        <div class="card-header" style="display: flex; justify-content: space-between; align-items: center;">
            <h3 style="margin: 0; font-size: 1.1rem;">Import Mahasiswa via CSV</h3>
