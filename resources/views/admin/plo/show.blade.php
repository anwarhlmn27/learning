                            ...
                            @forelse($plo->terms as $index => $term)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('plo.terms.destroy', $term->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Delete this term?');">
                                            @csrf
                                            @method('DELETE')
                            ...
                            @forelse($plo->indicators as $indicator)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('plo.indicators.destroy', $indicator->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Delete this indicator?');">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-sm btn-danger">Delete</button>
                                        </form>
