...
(function($) {
	...
	var headerBg = getCookie('headerBg') || "color_1";
	var navheaderBg = getCookie('navheaderBg') || "color_3";
	var sidebarBg = getCookie('sidebarBg') || "color_1";
	var typography = getCookie('typography') || "poppins";
	...
	var assetBase = typeof assetBaseUrl !== 'undefined' ? assetBaseUrl : '';
	if(direction == 'rtl' || body.attr('direction') == 'rtl'){
        direction = 'rtl';
		jQuery('.main-css').attr('href', assetBase + 'css/style-rtl.css');
    }else{
        direction = 'ltr';
		jQuery('.main-css').attr('href', assetBase + 'css/style.css');
	}
